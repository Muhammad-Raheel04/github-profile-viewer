...
const EmptyState = () => {
  return (
    <div className='flex flex-col justify-center items-center mt-20 text-gray gap-3'>
      ...
      <h1 className='text-2xl font-semibold text-center'>Search for a GitHub Profile</h1>
      <p className='text-gray-400 text-center'>Enter a username to view their profile and repositories</p>
      <p>Try: <span className='bg-gray-200 rounded-md p-1 text-center'>Muhammad-Raheel04</span></p>
    </div>
  )
}
